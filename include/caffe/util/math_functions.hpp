...
template <typename Dtype> 
void caffe_gpu_sigmoid_forward(int N, const Dtype* bottom, Dtype* top);
template <typename Dtype> 
void caffe_gpu_sigmoid_backward(int N,const Dtype* top_data, const Dtype* top_diff, Dtype* bottom_diff);
template <typename Dtype>
void caffe_gpu_relu_forward(int N, const Dtype* bottom, Dtype* top) ;
template <typename Dtype>
void caffe_gpu_relu_backward(int N, const Dtype* top_data,const Dtype* top_diff, Dtype* bottom_diff);
template <typename Dtype>
void caffe_gpu_tanh_forward(int N, const Dtype* bottom, Dtype* top);
template <typename Dtype>
void caffe_gpu_tanh_backward(int N, const Dtype* top_data,const Dtype* top_diff, Dtype* bottom_diff);
